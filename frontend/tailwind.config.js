  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glass-lg': '0 20px 40px 0 rgba(31, 38, 135, 0.45)',
        'neon': '0 0 5px theme(colors.primary.400), 0 0 20px theme(colors.primary.700)',
        'neon-lg': '0 0 10px theme(colors.primary.400), 0 0 40px theme(colors.primary.700), 0 0 80px theme(colors.primary.800)',
        'inner-lg': 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.15)',
        'smooth': '0 2px 20px rgba(0, 0, 0, 0.08)',
        'smooth-lg': '0 4px 40px rgba(0, 0, 0, 0.12)',
      },
      backdropBlur: {
        xs: '2px',
      },
      ...
      keyframes: {
        ...
        glow: {
          ...
          '100%': { boxShadow: '0 0 30px rgba(168, 85, 247, 0.8), 0 0 60px rgba(168, 85, 247, 0.4)' }
        },
        'slide-up': {
      ...
      backgroundImage: {
        ...
        'gradient-rainbow': 'linear-gradient(90deg, #ff0080, #ff8c00, #40e0d0, #4169e1, #9370db)',
