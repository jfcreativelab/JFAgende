        ...
        {abaAtiva === 'portfolio' && (
          <div className="space-y-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Gerencie sua logo, galeria de fotos e identidade visual do estabelecimento
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                  Mostre seu trabalho e ambiente para atrair mais clientes
                </p>
                <Card className="p-6">
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-4">
                      Em breve você poderá fazer upload de fotos do seu trabalho
                    </p>
            ...
            <Card className="p-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">
                ℹ️ Informações do Estabelecimento
              </h3>
              ...
              <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Para alterar outras informações, entre em contato com o suporte.
                </p>
              </div>
            </Card>
          </div>
