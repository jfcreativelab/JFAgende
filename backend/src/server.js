...
import planoEstabelecimentoRoutes from './routes/planoEstabelecimentoRoutes.js';
import assinaturaPlanoRoutes from './routes/assinaturaPlanoRoutes.js';
...
app.use('/api/planos-estabelecimento', planoEstabelecimentoRoutes);
app.use('/api/assinatura-plano', assinaturaPlanoRoutes);
